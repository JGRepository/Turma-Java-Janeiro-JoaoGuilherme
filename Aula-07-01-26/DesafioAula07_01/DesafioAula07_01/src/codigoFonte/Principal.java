...
public class Principal {
	...
	public static void main(String[] args) {
		...
		String opcao = entradaDados.next();
			...
			jogadorFutsal.nomeAtleta = entradaDados.next();

			System.out.println("Qual a idade do Jogador de Futsal");
			jogadorFutsal.idade = entradaDados.nextInt();
	
			System.out.println("Qual é a perna mais forte?");
			jogadorFutsal.pernaMaisForte = entradaDados.next();
	
			System.out.println("Qual é o valor por Gol marcado?");
			jogadorFutsal.valorPorGols = entradaDados.nextDouble();
