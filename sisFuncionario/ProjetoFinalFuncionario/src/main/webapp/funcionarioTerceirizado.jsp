...
<%
    ...
    String lucroValue = "";
    if (editando && funcionarioEdit.getLucro() != null) {
        lucroValue = funcionarioEdit.getLucro().toString();
    }
%>
...
<form method="post" action="<%= request.getContextPath() %>/FuncionarioTerceirizadoController">
    ...
    <label>LUCRO EMPRESA (R$):</label><br>
    <input type="text" name="lucro" value="<%= lucroValue %>" required ><br>
...
%>
    <tr>
        ...
        <td><%= funcionarioTerceirizado.getDataNascimento() %></td>
        <td><%= funcionarioTerceirizado.getFuncao() %></td>
        <td><%= funcionarioTerceirizado.getEmpresa() %></td>
        <td><%= funcionarioTerceirizado.getHorasTrabalhadas() %></td>
        <td><%= funcionarioTerceirizado.getLucro() %></td>
        <td><%= funcionarioTerceirizado.getCusto() %></td>
        <td>
            <form method="get" action="<%= request.getContextPath() %>/FuncionarioTerceirizadoController" style="display:inline;">
